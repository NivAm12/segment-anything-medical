...
if __name__ == "__main__":
    ...
    parser.add_argument('--image_path', type=str, default="/Users/amitaflalo/Desktop/Sampl_Dino", help='path of the extracted image.')
    parser.add_argument('--output_path', type=str, default="/Users/amitaflalo/Desktop/Sampl_Dino", help='path to file containing extracted descriptors.')
